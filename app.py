...
app = Flask(__name__, template_folder=r"C:\project\Careerprediction\templates")

# Load the trained model
model = pickle.load(open(r'C:\project\Careerprediction\Model\model.pkl', 'rb'))
label_encoders = pickle.load(open(r'C:\project\Careerprediction\Model\label_encoders.pkl', 'rb'))
